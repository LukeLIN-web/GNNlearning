...
https://www.jmlr.org/author-info.html  JMLR 发表有关机器学习理论和方法的论文，但不发表机器学习在其他领域的应用。
...
第一次投不需要太正式的模板，只要章节顺序和正式发表都一致就行.

投稿后编辑会卡两周左右给回复，如果送审的话大概一个半月出一审意见。全流程下来差不多7个月左右吧.
...
✅ 如果你要投 **Nature 子刊/相关 Springer Nature 期刊**，最核心的就是：
